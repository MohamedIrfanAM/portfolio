...
const Projects = () => {
  return (
    <section className="w-screen overflow-hidden py-14 lg:pr-24 h-screen " id='projects'>
      <motion.h1 className={`text-center text-4xl font-bold mx-10 relative left-2 bg-clip-text text-transparent bg-gradient-to-r from-primary to-cyan-400`} variants={fadeIn("left","spring",0.2,0.75)} initial='hidden' whileInView='visible'>Recent Projects</motion.h1>
